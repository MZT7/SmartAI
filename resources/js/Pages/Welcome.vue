...
onMounted(() => {
    ...
    window.Echo.channel('autoBots')
        .listen('AutobotCreated', (e) => {
            autoBotCount.value = e.count
            console.log(e);

        })
})

// const data = ref(props.count)

// const posts = computed(() => data.value)

// watchEffect(() => {
//     console.log(`Count is now ${props.count}`)
// })

// watch(usePage().props.count, (newItem) => {
                ...
                <main class="mt-6">
                    <div class="">
                        ...
                        <a href="https://laracasts.com"
                            ...
                            <div class="w-40 whitespace-nowrap ">
                                <h1>Autobots Count:</h1>
                            </div>

                            <div class="">
                                <h2 class="text-xl font-semibold text-black dark:text-white">{{ autoBotCount || "me" }}
                                </h2>
                            </div>
